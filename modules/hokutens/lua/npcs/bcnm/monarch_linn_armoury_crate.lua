...
local m = Module:new("monarch_linn_armoury_crate")

xi.module.ensureTable("xi.zones.Monarch_Linn.npcs.Armoury_Crate")
...
cu.reloadOverride(m, "xi.zones.Monarch_Linn.npcs.Armoury_Crate.onTrigger", function(player, npc)
