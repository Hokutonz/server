...
-----------------------------------
xi.module.ensureTable("xi.zones.Riverne-Site_B01.mobs.Bahamut")
local m = Module:new("wyrmking_bahamut")
-----------------------------------
...
m:addOverride("xi.zones.Riverne-Site_B01.mobs.Bahamut.onMobSpawn", function(mob)
    ...
    mob:addStatusEffect(xi.effect.SHELL, 2930, 0, 1800) -- Shell_V
    mob:setMobAbilityEnabled(true)
    mob:setMagicCastingEnabled(true)
    mob:setAutoAttackEnabled(true)
end)

m:addOverride("xi.zones.Riverne-Site_B01.mobs.Bahamut.onMobEngaged", function(mob)
    mob:setMobMod(xi.mobMod.NO_MOVE, 0)
end)

m:addOverride("xi.zones.Riverne-Site_B01.mobs.Bahamut.onMobFight", function(mob, target)
...
m:addOverride("xi.zones.Riverne-Site_B01.mobs.Bahamut.onMobWeaponSkill", function(target, mob, skill)
end)

m:addOverride("xi.zones.Riverne-Site_B01.mobs.Bahamut.onMobDisengage", function(mob)
end)

m:addOverride("xi.zones.Riverne-Site_B01.mobs.Bahamut.onAdditionalEffect", function(mob, target, damage)
end)
