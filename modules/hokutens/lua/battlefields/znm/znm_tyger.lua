...
-----------------------------------
local m = Module:new("znm_tyger")

xi.module.ensureTable("xi.zones.Caedarva_Mire.mobs.Tyger")

m:addOverride("xi.zones.Caedarva_Mire.mobs.Tyger.onMobInitialize", function(mob)
    g_mixins.rage(mob)
...
m:addOverride("xi.zones.Caedarva_Mire.mobs.Tyger.onMobSpawn", function(mob)
