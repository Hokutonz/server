...
-----------------------------------
local m = Module:new("znm_iriri_samariri")

xi.module.ensureTable("xi.zones.Mamook.mobs.Iriri_Samariri")

m:addOverride("xi.zones.Mamook.mobs.Iriri_Samariri.onMobInitialize", function(mob)
...
m:addOverride("xi.zones.Mamook.mobs.Iriri_Samariri.onMobSpawn", function(mob)
