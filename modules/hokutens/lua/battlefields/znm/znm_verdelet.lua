...
-----------------------------------
local m = Module:new("znm_verdelet")

xi.module.ensureTable("xi.zones.Caedarva_Mire.mobs.Verdelet")

m:addOverride("xi.zones.Caedarva_Mire.mobs.Verdelet.onMobInitialize", function(mob)
    g_mixins.families.imp(mob)
    g_mixins.rage(mob)
...
m:addOverride("xi.zones.Caedarva_Mire.mobs.Verdelet.onMobSpawn", function(mob)
