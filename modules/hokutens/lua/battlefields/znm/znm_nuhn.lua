...
-----------------------------------
local m = Module:new("znm_nuhn")

xi.module.ensureTable("xi.zones.Arrapago_Reef.mobs.Nuhn")

m:addOverride("xi.zones.Arrapago_Reef.mobs.Nuhn.onMobInitialize", function(mob)
...
m:addOverride("xi.zones.Arrapago_Reef.mobs.Nuhn.onMobSpawn", function(mob)
...
m:addOverride("xi.zones.Arrapago_Reef.mobs.Nuhn.onAdditionalEffect", function(mob)
