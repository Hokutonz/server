...
-----------------------------------
local m = Module:new("znm_zareehkl_the_jubilant")

xi.module.ensureTable("xi.zones.Arrapago_Reef.mobs.Zareehkl_the_Jubilant")

m:addOverride("xi.zones.Arrapago_Reef.mobs.Zareehkl_the_Jubilant.onMobInitialize", function(mob)
    g_mixins.families.qutrub(mob)
